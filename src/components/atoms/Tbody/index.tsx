/**
 * @fileoverview Defines Tbody atom (re-exportation for backward compatibility).
...
import { Tbody, css } from '@chakra-ui/react';
import styled from '@emotion/styled';

export const Component = styled(Tbody)((props) =>
  css({
    // Placeholder.
  })(props.theme),
);

Component.displayName = 'Tbody';
