/**
 * @fileoverview Defines Th atom (re-exportation for backward compatibility).
...
import { Th, css } from '@chakra-ui/react';
import styled from '@emotion/styled';

export const Component = styled(Th)((props) =>
  css({
    // Placeholder.
  })(props.theme),
);

Component.displayName = 'Th';
