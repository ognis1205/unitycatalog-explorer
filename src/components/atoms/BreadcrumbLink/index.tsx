/**
 * @fileoverview Defines BreadcrumbLink atom (re-exportation for backward compatibility).
...
import { BreadcrumbLink, css } from '@chakra-ui/react';
...
export const Component = styled(BreadcrumbLink)((props) =>
  css({
    // Placeholder.
  })(props.theme),
);

Component.displayName = 'BreadcrumbLink';
