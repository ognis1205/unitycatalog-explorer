...
import { AbsoluteCenter, css } from '@chakra-ui/react';
import styled from '@emotion/styled';

import type { AbsoluteCenterProps } from '@chakra-ui/react';

export type Props = AbsoluteCenterProps;

export const Component = styled(AbsoluteCenter)((props) =>
  css({
    // Placeholder.
  })(props.theme),
);

Component.displayName = 'AbsoluteCenter';
