/**
 * @fileoverview Defines Tr atom (re-exportation for backward compatibility).
...
import { Tr, css } from '@chakra-ui/react';
import styled from '@emotion/styled';

export const Component = styled(Tr)((props) =>
  css({
    // Placeholder.
  })(props.theme),
);

Component.displayName = 'Tr';
