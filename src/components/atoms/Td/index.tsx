/**
 * @fileoverview Defines Td atom (re-exportation for backward compatibility).
...
import { Td, css } from '@chakra-ui/react';
import styled from '@emotion/styled';

export const Component = styled(Td)((props) =>
  css({
    // Placeholder.
  })(props.theme),
);

Component.displayName = 'Td';
