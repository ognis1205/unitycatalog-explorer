/**
 * @fileoverview Defines Table atom (re-exportation for backward compatibility).
...
import { Table, css } from '@chakra-ui/react';
...
export const Component = styled(Table)((props) =>
  css({
    // Placeholder.
  })(props.theme),
);
