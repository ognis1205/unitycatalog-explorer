/**
 * @fileoverview Defines Divider atom (re-exportation for backward compatibility).
...
import { Divider, css } from '@chakra-ui/react';
...
export const Component = styled(Divider)((props) =>
  css({
    // Placeholder.
  })(props.theme),
);
