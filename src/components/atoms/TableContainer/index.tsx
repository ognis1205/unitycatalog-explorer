/**
 * @fileoverview Defines TableContainer atom (re-exportation for backward compatibility).
...
import { TableContainer, css } from '@chakra-ui/react';
...
export const Component = styled(TableContainer)((props) =>
  css({
    // Placeholder.
  })(props.theme),
);

Component.displayName = 'TableContainer';
