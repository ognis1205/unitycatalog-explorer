/**
 * @fileoverview Defines HStack atom (re-exportation for backward compatibility).
...
import { css, HStack } from '@chakra-ui/react';
...
export const Component = styled(HStack)((props) =>
  css({
    // Placeholder.
  })(props.theme),
);

Component.displayName = 'HStack';
