/**
 * @fileoverview Defines Tfoot atom (re-exportation for backward compatibility).
...
import { Tfoot, css } from '@chakra-ui/react';
import styled from '@emotion/styled';

export const Component = styled(Tfoot)((props) =>
  css({
    // Placeholder.
  })(props.theme),
);

Component.displayName = 'Tfoot';
