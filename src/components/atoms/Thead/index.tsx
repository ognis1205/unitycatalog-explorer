/**
 * @fileoverview Defines Thead atom (re-exportation for backward compatibility).
...
import { Thead, css } from '@chakra-ui/react';
import styled from '@emotion/styled';

export const Component = styled(Thead)((props) =>
  css({
    // Placeholder.
  })(props.theme),
);

Component.displayName = 'Thead';
